...
public class CircuitBreakerHelper {
    ...
    public <T> T apiFallback(String url, Class<T> responseType, Exception exception) {
        logger.error("Circuit breaker triggered for url {} | response type {} ", url, responseType, exception);
        return null;
    }
}
